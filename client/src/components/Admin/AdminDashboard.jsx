...
const AdminDashboard = () => {
  ...
  return (
    <>
      <div className="md:mx- font-mentra text-4xl text-center my-6">
        Admin Dashboard
      </div>
      <form
      ...
      >
        ...
        <button
          type="submit"
          className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline col-span-2 mx-44"
        >
          Submit
        </button>
      </form>
