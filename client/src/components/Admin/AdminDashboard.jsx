  ...
  return (
   <>
      ...
      <form onSubmit={handleSubmit} className="max-w-md mx-auto my-8 p-4 bg-white shadow-md rounded-md">
        ...
        <div className="mb-4">
          <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="name">Model name</label>
          <input
            type="text"
            name="companymodel"
            id="companymodel"
        ...
        <div className="mb-4">
          <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="category">Color way</label>
          <input
            type="text"
            name="colorway"
            id="colorway"
        ...
        <div className="mb-4">
          <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="category">Product about</label>
          <input
            type="text"
            name="about"
            id="about"
        ...
        <div className="mb-4">
          <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="category">Country</label>
          <input
            type="text"
            name="country"
            id="country"
