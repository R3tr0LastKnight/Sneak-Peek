          ...
          <>
            ...
            >
              ...
              <p className="w-1/2 hidden lg:flex">
                ...
                earum error ex necessitatibus expedita facere animi magni
                deserunt quisquam corrupti. Libero expedita totam officia ipsam
                deserunt veritatis adipisci deleniti iste!
              </p>
              <button
                onClick={() => {
                  setShowModal(true);
