...
const IndexProd = ({ setShowModal, setSelectedProductId }) => {
  ...
  return (
    <div className="grid mx-4 lg:mx-12 grid-cols-1 lg:grid-cols-3 select-none ">
      {products.map((product) => (
        <div key={product._id}>
          <span className="flex border shadow-[0_3px_10px_rgb(0,0,0,0.2)] lg:mx-4 my-4 rounded-lg">
